        ...
        <>
            ...
            <div className="flex flex-col bg-case bg-cover bg-no-repeat px-8 xl:px-24 2xl:px-40 py-10">
                <div className="flex flex-col gap-4 items-start justify-center">
                    <div className="relative">
                        ...
                        <Image src="/images/heading_shapes.png" className="absolute top-4 left-0 w-auto" width={40} height={150} />
                        ...
                        <div className="absolute bottom-0 -right-16 animate-spin2">
                            <Image src="/images/Frame.png" className="w-auto" width={100} height={100} />
                        </div>
                    </div>
                    <Image src="/images/banner_img_1.png" className="w-full" width={800} height={400} />
                </div>
            </div>
            ...
            <div class="overflow-hidden whitespace-nowrap relative">
                ...
                <div className="bg-primary transform -rotate-2 relative z-50 py-4">
                    <div class="animate-marquee text-lg font-bold text-white items-center flex gap-x-24 ">
                        <div class="mx-4 relative flex gap-x-4 items-center"> <Image src="/images/icon-s-32.webp" className="w-auto bg-white p-2 rounded-full" width={20} height={20} /> <span className="text-4xl font-bold"> Web Development </span> </div>
                        <div class="mx-4 relative flex gap-x-4 items-center"> <Image src="/images/icon-s-32.webp" className="w-auto bg-white p-2 rounded-full" width={20} height={20} /> <span className="text-4xl font-bold"> Web Development </span> </div>
                        <div class="mx-4 relative flex gap-x-4 items-center"> <Image src="/images/icon-s-32.webp" className="w-auto bg-white p-2 rounded-full" width={20} height={20} /> <span className="text-4xl font-bold"> Web Development </span> </div>
                        <div class="mx-4 relative flex gap-x-4 items-center"> <Image src="/images/icon-s-32.webp" className="w-auto bg-white p-2 rounded-full" width={20} height={20} /> <span className="text-4xl font-bold"> Web Development </span> </div>
                        <div class="mx-4 relative flex gap-x-4 items-center"> <Image src="/images/icon-s-32.webp" className="w-auto bg-white p-2 rounded-full" width={20} height={20} /> <span className="text-4xl font-bold"> Web Development </span> </div>
