  ...
  <div className="hydration"  data-suppress-hydration-warning="true" 
   data-new-gr-c-s-check-loaded="14.1211.0" data-gr-ext-installed="true">
                    ...
                    <div className="flex flex-wrap">
                        <div className="w-1/3">
                            <div className="flex text-white relative p-6 ">
                                <div className="relative w-full rounded-xl">
                                    ...
                                    <Image src="/images/client4.png" className="w-full rounded-xl" width={400} height={100} quality={100} />
                                </div>
                        ...
                        <div className="w-1/3">
                            <div className="flex text-white relative p-6">
                                <div className="relative w-full">
                                    <div className="before:content-[*] before w-full h-full bg-clientapp cursor-pointer hover:bg-clientapp2 bottom-0 absolute rounded-xl hover:bg-primary hover:opacity-30"></div>
                                    <Image src="/images/client5.png" className="w-full rounded-xl" width={400} height={100} quality={100} />
                                </div>
                                <div className="absolute bottom-8 py-6 px-4">
                        ...
                        <div className="w-1/3">
                            <div className="flex text-white relative p-6">
                                <div className="relative w-full ">
                                    <div className="before:content-[*] before w-full h-full bg-clientapp cursor-pointer hover:bg-clientapp2 bottom-0 absolute rounded-xl hover:bg-primary hover:opacity-30"></div>
                                    <Image src="/images/client6.png" className="w-full rounded-xl" width={400} height={100} quality={100} />
                                </div>
                                <div className="absolute bottom-8 py-6 px-4">
        ...
        <div className="bg-purpleoff relative py-28">
            <div className="max-w-screen-1xl mx-auto">
                <div className="flex justify-center items-center relative px-32 z-0">
                    <div className="flex w-40 h-40 justify-center items-center absolute z-20 text-white bg-blackl border border-white rounded-full">
                        ...
                        <Image src="/images/clients.png" className="w-full" width={1000} height={500} quality={100} />
                        <div className="flex flex-col absolute -top-10 left-40 h-72 w-72 justify-between text-white bg-darkn p-6 rounded-3xl">
                            <div className="flex">
                                <Image src="/images/testi-thumb.png" className="w-auto relative z-20" width={50} height={50} />
            ...
            <Image src="/images/shapes.png" className="w-auto absolute top-10 left-0" width={100} height={100} />
            <Image src="/images/clients2.png" className="w-auto absolute bottom-10 right-0" width={100} height={100} />
        </div>
    </div>
  </>  
  );
